defmodule YoganHockeyWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(YoganHockeyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(YoganHockeyWeb.Gettext, "errors", msg, opts)
    end
  end
